...
public class SpawnerComponent extends Component {
	...
	private final Property<Trigger> trigger;
	...
	public SpawnerComponent(Property<Timer> spawnTimer, Property<IntValue> minTime, Property<IntValue> maxTime, Property<Trigger> trigger) {
	...
	public SpawnerComponent(Timer spawnTimer, int minTime, int maxTime, Trigger trigger) {
		this(PropertyBuilder.property(spawnTimer), PropertyBuilder.property(ValueBuilder.intValue(minTime)), 
				PropertyBuilder.property(ValueBuilder.intValue(maxTime)), PropertyBuilder.property(trigger));
	}
}
